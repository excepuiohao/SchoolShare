...
<div style="border: solid silver 1px;width: 348px">
	<form action="AdminUpdateUserCredit" method="get" style=" margin-top: 20px;">
		个人号码：<input type="text" name="userId" value=<%=user.getUserId() %> readonly="readonly"> <br> 密&nbsp;&nbsp;码：<input type="text"
			...
			name="userCredit" ><br>用户积分：<input type="text"
			name="userIntegral" value=<%=user.getUserIntegral()%> readonly="readonly"><br>姓&nbsp;&nbsp;名：<input type="text"
