...
/**
 * Servlet implementation class AdminUpdateUserIntegral
 */
@WebServlet("/AdminUpdateUserIntegral")
public class AdminUpdateUserIntegral extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminUpdateUserIntegral() {
        super();
