...
/**
 * Servlet implementation class AdminFindUserCredit
 */
@WebServlet("/AdminFindUserCredit")
public class AdminFindUserCredit extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFindUserCredit() {
        super();
