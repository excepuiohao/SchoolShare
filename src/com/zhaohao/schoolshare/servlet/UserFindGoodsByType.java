...
/**
 * Servlet implementation class UserFindGoodsByType
 */
@WebServlet("/UserFindGoodsByType")
public class UserFindGoodsByType extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserFindGoodsByType() {
        super();
