...
/**
 * Servlet implementation class UserFindLease
 */
@WebServlet("/UserFindLease")
public class UserFindLease extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserFindLease() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("”√ªßid£∫"+userId);
		ResultSet rs=null;
		try {
